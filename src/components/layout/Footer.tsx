...
export default function Footer() {
  ...
  return (
    ...
    >
      <div
        className="mx-auto px-[var(--space-5)] sm:px-[var(--space-8)] lg:px-[var(--space-12)]"
        style={{
            ...
            <div className="mb-6">
              ...
              {subscribed ? (
                ...
                <form onSubmit={handleSubscribe} className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 text-white text-sm font-semibold transition-colors"
                    style={{
                      background: 'var(--color-brand-500)',
                      borderRadius: 'var(--radius-lg)',
                    }}
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 flex items-center justify-center text-[var(--text-400)] hover:text-[var(--text-100)] hover:bg-[var(--surface-2)] transition-all"
                  style={{ borderRadius: 'var(--radius-lg)' }}
