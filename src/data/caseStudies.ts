...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    solution:
      'Deployed an AI-powered triage agent that assesses patient symptoms in real-time, prioritizes cases by urgency, and routes patients to the appropriate specialist. Integrated with existing EHR systems and added multilingual support.',
    results: [
